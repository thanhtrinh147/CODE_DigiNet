...
Module D13X0004
    ...
    Public Sub LoadSystems()
        ...
        D13Systems.IsUseBlock = L3Bool(ReturnScalar("Select IsUseBlock From D09T0000 WITH (NOLOCK) "))
        '        Dim dtD09 As DataTable = ReturnDataTable("Select IsUseBlock From D09T0000")
    ...
    ''' <summary>
    ''' Thông báo trước khi mở phiếu
    ''' </summary>    
    Public Function AskUnLocked() As DialogResult
        If D13Options.MessageAskBeforeSave Then
            Return D99C0008.Msg(rl3("Ban_co_muon_mo_phieu_nay_khong"), rl3("Thong_bao"), L3MessageBoxButtons.YesNo, L3MessageBoxIcon.Question, MessageBoxDefaultButton.Button2)
        Else
            Return DialogResult.Yes
        End If
    End Function
