...
'# Ngày cập nhật cuối cùng: 04/07/2013
...
'# Sửa lỗi xuất excel tại máy cài office2003 nhưng khi qua máy office2007 thì không mở file được
'#######################################################################################
...
Module D99X2224
    ...
    Public Function ExportToExcelMax(ByVal dtData As DataTable, ByVal dtCaptionCols As DataTable, ByVal sPath As String, ByVal sFileName As String, ByVal bOpenFile As Boolean, Optional ByVal sFirstCol As String = "A", Optional ByVal iFirstRow As Integer = 1) As Boolean
        ...
        Try
            ...
            If giVersion2007 = 1 Then
                'Update 04/07/2013 Nếu Office2007 thì lưu mặc định xuống Office2003
    ...
    Public Function CheckVersionExcel(ByVal appExcel As Microsoft.Office.Interop.Excel.Application) As Boolean
