...
Public Enum enumD13E0140Form
    ...
    D13F1180 'Danh mục ---> B. Nhóm luơng
    D13F1000 'Danh mục ---> C. Khoản điều chỉnh thu nhập
    D13F1130 'Danh mục ---> D. Loại nghiệp vụ
    D13F1010 'Danh mục ---> E. Đối tượng thuế thu nhập
    D13F1140 'Danh mục ---> F. Đối tượng tính lương
    D13F1080 'Danh mục ---> G. Thưởng theo thâm niên
    D13F1070 'Danh mục ---> H. Đánh giá xếp loại
    D13F1040 'Danh mục ---> J. Ngạch lương
    D13F1050 'Danh mục ---> K. Bậc lương
    D13F1060 'Danh mục ---> L. Danh mục template tăng thông số lương
    D13F1160 'Danh mục ---> M. Thông số lương mặc định
    D13F1090 'Danh mục ---> N. Mã phân tích tiền lương
    D13F1100 'Danh mục ---> O. Bảng tham chiếu kết quả
    D13F1150 'Danh mục ---> P. Phương pháp điều chỉnh lương
    D13F2050 'Danh mục ---> Q. Phương pháp tính lương
...
Public Class D13E0140
    ...
    ''' FormState
    ''' </summary>
    Public WriteOnly Property In_FormState() As EnumFormState
