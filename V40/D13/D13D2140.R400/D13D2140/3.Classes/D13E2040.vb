...
Public Class D13E2040
    Private Const EXEMODULE As String = "D13"
    Private Const EXECHILD As String = "D13E2040"
    ...
    ''' </summary>
    Public WriteOnly Property FormActive() As enumD13E2040Form
        Set(ByVal Value As enumD13E2040Form)
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Ctrl01", [Enum].GetName(GetType(enumD13E2040Form), Value))
        End Set
    End Property
