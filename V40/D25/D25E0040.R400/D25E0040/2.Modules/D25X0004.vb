...
Public Structure StructureSystem
    ...
    '''' <summary>
    '''' Thiết lập Mã thông báo tuyển dụng  tự động
    '''' </summary>
    '''' <remarks></remarks>
    ...
    '''' </summary>
    '''' <remarks></remarks>
    'Public CandidateS1Type As Boolean
    '''' <summary>
    '''' Theo tên
    '''' </summary>
    '''' <remarks></remarks>
    'Public CandidateS2Type As Boolean
    '''' <summary>
    '''' Phân loại khác
    '''' </summary>
    '''' <remarks></remarks>
    'Public CandidateS3Type As Boolean
    ''' <summary>
    ''' Dấu phân cách
    ''' </summary>
    ''' <remarks></remarks>
    ...
    '''' </summary>
    '''' <remarks></remarks>
    'Public CandidateOutputLength As Integer
    '''' <summary>
    '''' Phần bổ sung
    '''' </summary>
    '''' <remarks></remarks>
    'Public SubsidizeAuto As Boolean
    '''' <summary>
    '''' Trước phần tự động
    '''' </summary>
    '''' <remarks></remarks>
    'Public CandidateS4Type As Boolean
    '''' <summary>
    '''' Sau phần tự động
    '''' </summary>
    '''' <remarks></remarks>
    'Public CandidateS5Type As Boolean
...
Module D25X0004
    ...
    ''' <summary>
    ''' Form Main của Module D25
    ''' </summary>
    Public frmD25F0000 As D25F0000
    ''' <summary>
    ...
    Public Sub LoadSystems()
        ...
        If dt.Rows.Count > 0 Then
            With D25Systems
                ...
                '.AutoRecInformationID = L3Bool(dt.Rows(0).Item("AutoRecInformationID"))    'IncidentID	51129
                '.AutoInterviewFileID = L3Bool(dt.Rows(0).Item("AutoInterviewFileID"))
                ''.AbsentTypeAuto = L3Bool(dt.Rows(0).Item("AbsentTypeAuto")) ''Phần tự động
                '.CandidateS1Type = L3Bool(dt.Rows(0).Item("CandidateS1Type"))
                '.CandidateS2Type = L3Bool(dt.Rows(0).Item("CandidateS2Type"))
                '.CandidateS3Type = L3Bool(dt.Rows(0).Item("CandidateS3Type"))
                '.CandidateOutputOrder = L3Int(dt.Rows(0).Item("CandidatetOutputOrder"))
                '.CandidateSeparator = dt.Rows(0).Item("CandidateSeparator").ToString
                '.CandidateOutputLength = L3Int(dt.Rows(0).Item("CandidateOutputLength"))
                '.SubsidizeAuto = L3Bool(dt.Rows(0).Item("SubsidizeAuto")) 'Phần bo sung
                '.CandidateS4Type = L3Bool(dt.Rows(0).Item("CandidateS4Type"))
                '.CandidateS5Type = L3Bool(dt.Rows(0).Item("CandidateS5Type"))
        ...
        Else
            With D25Systems
                ...
                '.CandidateS1Type = False
                '.CandidateS2Type = False
                '.CandidateS3Type = False
                .CandidateOutputOrder = 0
                .CandidateSeparator = "/"
                '.CandidateOutputLength = 5
                '.SubsidizeAuto = False
                '.CandidateS4Type = False
                '.CandidateS5Type = False
                .IsUseAppRecruitProposal = False
            End With
        End If
