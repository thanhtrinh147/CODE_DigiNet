...
#Region "Const of tdbg - Total of Columns: 40"
    ...
    Private Const COL_BlockName As Integer = 7         ' Tên khối
    ...
    Private Const COL_MethodName As Integer = 13       ' Phương pháp chấm công
    Private Const COL_IsSpec As Integer = 14           ' Quy cách
    Private Const COL_CreateUserID As Integer = 15     ' CreateUserID
    Private Const COL_CreateDate As Integer = 16       ' CreateDate
    Private Const COL_LastModifyUserID As Integer = 17 ' LastModifyUserID
    Private Const COL_LastModifyDate As Integer = 18   ' LastModifyDate
    Private Const COL_DateFrom As Integer = 19         ' DateFrom
    Private Const COL_DateTo As Integer = 20           ' DateTo
    Private Const COL_TransTypeID As Integer = 21      ' TransTypeID
    Private Const COL_TransDAGroupID As Integer = 22   ' TransDAGroupID
    Private Const COL_PreparerID As Integer = 23       ' PreparerID
    Private Const COL_ProductID As Integer = 24        ' Mã sản phẩm
    Private Const COL_ProductName As Integer = 25      ' Tên sản phẩm
    Private Const COL_StageID As Integer = 26          ' Mã công đoạn
    Private Const COL_StageName As Integer = 27        ' Tên công đoạn
    Private Const COL_RefEmployeeID As Integer = 28    ' Mã nhân viên phụ
    Private Const COL_EmployeeID1 As Integer = 29       ' Mã nhân viên
    Private Const COL_EmployeeName As Integer = 30     ' Họ và tên
    Private Const COL_DepartmentID1 As Integer = 31     ' Mã phòng ban
    Private Const COL_TeamID1 As Integer = 32           ' Mã tổ nhóm
    Private Const COL_Quantity01 As Integer = 33       ' Số lượng 01
    Private Const COL_Quantity02 As Integer = 34       ' Số lượng 02
    Private Const COL_Quantity03 As Integer = 35       ' Số lượng 03
    Private Const COL_Quantity04 As Integer = 36       ' Số lượng 04
    Private Const COL_Quantity05 As Integer = 37       ' Số lượng 05
    Private Const COL_PayrollVoucherID As Integer = 38 ' PayrollVoucherID
    Private Const COL_Method As Integer = 39           ' Method
#End Region
    ...
    Private Sub Loadlanguage()
        ...
        mnuImportD45F2000D.Text = rL3("Theo_nhom_nhan_vien")

        '================================================================ 

        tdbg.Columns(COL_BlockID).Caption = rL3("Ma_khoi") 'Mã khối
        tdbg.Columns(COL_BlockName).Caption = rl3("Ten_khoi")'Tên khối '120665 - 26 June 2019
...
#End Region
    ...
    '# Created Date: 16/05/2018 11:25:28
    '#---------------------------------------------------------------------------------------------------
    ...
    Private Sub mnuDelete_Click(ByVal sender As Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles mnuDelete.Click
        ...
        sSQL &= SQLDeleteD45T2000() & vbCrLf
        sSQL &= SQLDeleteD45T2070()
...
#End Region
    ...
    '122333  - 29/08/2019
    Private Sub mnuImportD45F2000D_Click(ByVal sender As Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles mnuImportD45F2000D.Click
        Me.Cursor = Cursors.WaitCursor
        If CallShowDialogD80F2090("D45", "D45F5603", "D45F2000D") Then
            'Load lại dữ liệu
            LoadTDBGrid()
        End If
        Me.Cursor = Cursors.Default
