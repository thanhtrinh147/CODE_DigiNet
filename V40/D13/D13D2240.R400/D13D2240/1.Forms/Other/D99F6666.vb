...
#End Region
    ...
    ''DxxX0004: Tùy thuộc từng module có biến lưu dưới Registry
    ...
    '    D07Options.ShowReportPath = bShowReportPath 'Biến Tùy chọn
    '    'Nếu module nào có thêm code VB6 thì lưu thêm nhánh VB6
    '    'D99C0007.SaveModulesSetting("D07", ModuleOption.lmOptions, "DisabledPathReport", bShowReportPath)
    'End Sub
