...
#Region "Const of tdbg - Total of Columns: 56"
    ...
    Private Const COL_DepartmentName As Integer = 9    ' Tên phòng ban
    Private Const COL_TeamID As Integer = 10           ' Mã tổ nhóm
    Private Const COL_TeamName As Integer = 11         ' Tên tổ nhóm
    Private Const COL_ProductID As Integer = 12        ' Sản phẩm
    Private Const COL_ProductName As Integer = 13      ' Tên sản phẩm
    Private Const COL_StageID As Integer = 14          ' Mã công đoạn
    Private Const COL_StageName As Integer = 15        ' Tên công đoạn
    Private Const COL_Spec01ID As Integer = 16         ' Spec01ID
    Private Const COL_Spec02ID As Integer = 17         ' Spec02ID
    Private Const COL_Spec03ID As Integer = 18         ' Spec03ID
    Private Const COL_Spec04ID As Integer = 19         ' Spec04ID
    Private Const COL_Spec05ID As Integer = 20         ' Spec05ID
    Private Const COL_Spec06ID As Integer = 21         ' Spec06ID
    Private Const COL_Spec07ID As Integer = 22         ' Spec07ID
    Private Const COL_Spec08ID As Integer = 23         ' Spec08ID
    Private Const COL_Spec09ID As Integer = 24         ' Spec09ID
    Private Const COL_Spec10ID As Integer = 25         ' Spec10ID
    Private Const COL_Quantity01 As Integer = 26       ' Số lượng 01
    Private Const COL_Quantity02 As Integer = 27       ' Số lượng 02
    Private Const COL_Quantity03 As Integer = 28       ' Số lượng 03
    Private Const COL_Quantity04 As Integer = 29       ' Số lượng 04
    Private Const COL_Quantity05 As Integer = 30       ' Số lượng 05
    Private Const COL_Quantity06 As Integer = 31       ' Quantity06
    Private Const COL_Quantity07 As Integer = 32       ' Quantity07
    Private Const COL_Quantity08 As Integer = 33       ' Quantity08
    Private Const COL_Quantity09 As Integer = 34       ' Quantity09
    Private Const COL_Quantity10 As Integer = 35       ' Quantity10
    Private Const COL_Quantity11 As Integer = 36       ' Quantity11
    Private Const COL_Quantity12 As Integer = 37       ' Quantity12
    Private Const COL_Quantity13 As Integer = 38       ' Quantity13
    Private Const COL_Quantity14 As Integer = 39       ' Quantity14
    Private Const COL_Quantity15 As Integer = 40       ' Quantity15
    Private Const COL_Quantity16 As Integer = 41       ' Quantity16
    Private Const COL_Quantity17 As Integer = 42       ' Quantity17
    Private Const COL_Quantity18 As Integer = 43       ' Quantity18
    Private Const COL_Quantity19 As Integer = 44       ' Quantity19
    Private Const COL_Quantity20 As Integer = 45       ' Quantity20
    Private Const COL_Notes As Integer = 46            ' Ghi chú
    Private Const COL_Attachment As Integer = 47       ' Đính kèm           '120665 - 02 July 2019
    ...
    Private Const COL_OrderNo As Integer = 52          ' OrderNo
    Private Const COL_Apportion As Integer = 53        ' Apportion
    Private Const COL_OProductName As Integer = 54     ' OProductName
    Private Const COL_Permission As Integer = 55       ' Permission
    Private Const COL_ToTal As Integer = 56
#End Region
...
#End Region
    ...
    Private Sub LoadTDBGrid()
        ...
        'Add vao cot STT
        if dtGrid.Columns.Contains("OrderNum") = False  then
        ...
        For i As Integer = 0 To dtGrid.Rows.Count - 1
            dtGrid.Rows(i).Item("Attachment") = "(" & ReturnAttachmentNumber("D45T2001", dtGrid.Rows(i).Item("ProductID").ToString(), dtGrid.Rows(i).Item("EmployeeID").ToString(),txtProductVoucherNo.Text) & ")"  'Đính kèm
        Next
        ...
        Select Case L3Int(IIf(bColMove = False, e.ColIndex, arrayIndex(e.ColIndex)).ToString)
            ...
            Case COL_EmployeeID
                ...
                Else
                    ...
                    tdbg.Columns(COL_DepartmentName).Text = tdbdEmployeeID.Columns("DepartmentName").Text
                    tdbg.Columns(COL_TeamID).Text = tdbdEmployeeID.Columns("TeamID").Text
                    tdbg.Columns(COL_TeamName).Text = tdbdEmployeeID.Columns("TeamName").Text
                End If
                tdbg.Columns(COL_Attachment).Text = "(" & ReturnAttachmentNumber("D45T2001", tdbg.Columns(COL_ProductID).Text, tdbg.Columns(COL_EmployeeID).Text, txtProductVoucherNo.Text) & ")"  'Đính kèm
            Case COL_RefEmployeeID
                ...
                Else
                    ...
                    tdbg.Columns(COL_DepartmentName).Text = tdbdRefEmployeeID.Columns("DepartmentName").Text
                    tdbg.Columns(COL_TeamID).Text = tdbdRefEmployeeID.Columns("TeamID").Text
                    tdbg.Columns(COL_TeamName).Text = tdbdRefEmployeeID.Columns("TeamName").Text
                End If
                tdbg.Columns(COL_Attachment).Text = "(" & ReturnAttachmentNumber("D45T2001", tdbg.Columns(COL_ProductID).Text, tdbg.Columns(COL_EmployeeID).Text, txtProductVoucherNo.Text) & ")"  'Đính kèm
            Case COL_FirstName
                ...
                Else
                    ...
                    tdbg.Columns(COL_DepartmentName).Text = tdbdFirstName.Columns("DepartmentName").Text
                    tdbg.Columns(COL_TeamID).Text = tdbdFirstName.Columns("TeamID").Text
                    tdbg.Columns(COL_TeamName).Text = tdbdFirstName.Columns("TeamName").Text
                End If
                tdbg.Columns(COL_Attachment).Text = "(" & ReturnAttachmentNumber("D45T2001", tdbg.Columns(COL_ProductID).Text, tdbg.Columns(COL_EmployeeID).Text, txtProductVoucherNo.Text) & ")"  'Đính kèm
