...
#Region "Const of tdbg3"
    ...
    Private Const COL3_Disabled As Integer = 3    ' KSD
    Private Const COL3_Type As Integer = 4        ' Type
    Private Const COL3_Code As Integer = 5        ' Code
#End Region
...
#End Region
    ...
    Private Sub CreateData()
        Dim sSQL As String
        sSQL = "Select Convert(bit,Disabled) As Disabled, Type, Code, Formula, "
...
#End Region
    ...
    Private Function SQLUpdateD45T0010s() As StringBuilder
        ...
        For i As Integer = 0 To tdbg3.RowCount - 1
            ...
            sSQL.Append("ShortNameU = " & SQLStringUnicode(tdbg3(i, COL3_ShortName), gbUnicode, True)) 'nvarchar[500], NOT NULL
            sSQL.Append(" Where ")
