...
#End Region
    ...
    Private Sub GetCaptionSalBase()
        ...
        For i As Integer = 0 To dtSalBase.Rows.Count - 1
            ...
            Else
                tdbgD.Splits(SPLIT1).DisplayColumns(COL_BaseSalary01 + i).HeadingStyle.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.249999!)
            End If
    ...
    Private Sub GetCaptionSalCoeff(ByVal Split As Integer, ByVal colFrom As Integer)
        ...
        For i As Integer = 0 To 9 'dtSalCoeff.Rows.Count - 1
            ...
            Else
                tdbgD.Splits(1).DisplayColumns(COL_SalCoefficient01 + i).HeadingStyle.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.249999!)
            End If
