...
#Region "Const of tdbg - Total of Columns: 103"
    ...
    Private Const COL_Quantity20 As Integer = 49          ' Quantity20
    Private Const COL_TypeC01 As Integer = 50             ' TypeC01
    Private Const COL_TypeC02 As Integer = 51             ' TypeC02
    Private Const COL_TypeC03 As Integer = 52             ' TypeC03
    Private Const COL_TypeC04 As Integer = 53             ' TypeC04
    Private Const COL_TypeC05 As Integer = 54             ' TypeC05
    Private Const COL_TypeC06 As Integer = 55             ' TypeC06
    Private Const COL_TypeC07 As Integer = 56             ' TypeC07
    Private Const COL_TypeC08 As Integer = 57             ' TypeC08
    Private Const COL_TypeC09 As Integer = 58             ' TypeC09
    Private Const COL_TypeC10 As Integer = 59             ' TypeC10
    Private Const COL_TypeC11 As Integer = 60             ' TypeC11
    Private Const COL_TypeC12 As Integer = 61             ' TypeC12
    Private Const COL_TypeC13 As Integer = 62             ' TypeC13
    Private Const COL_TypeC14 As Integer = 63             ' TypeC14
    Private Const COL_TypeC15 As Integer = 64             ' TypeC15
    Private Const COL_TypeC16 As Integer = 65             ' TypeC16
    Private Const COL_TypeC17 As Integer = 66             ' TypeC17
    Private Const COL_TypeC18 As Integer = 67             ' TypeC18
    Private Const COL_TypeC19 As Integer = 68             ' TypeC19
    Private Const COL_TypeC20 As Integer = 69             ' TypeC20
    Private Const COL_TypeC21 As Integer = 70             ' TypeC21
    Private Const COL_TypeC22 As Integer = 71             ' TypeC22
    Private Const COL_TypeC23 As Integer = 72             ' TypeC23
    Private Const COL_TypeC24 As Integer = 73             ' TypeC24
    Private Const COL_TypeC25 As Integer = 74             ' TypeC25
    Private Const COL_TypeC26 As Integer = 75             ' TypeC26
    Private Const COL_TypeC27 As Integer = 76             ' TypeC27
    Private Const COL_TypeC28 As Integer = 77             ' TypeC28
    Private Const COL_TypeC29 As Integer = 78             ' TypeC29
    Private Const COL_TypeC30 As Integer = 79             ' TypeC30
    Private Const COL_TypeC31 As Integer = 80             ' TypeC31
    Private Const COL_TypeC32 As Integer = 81             ' TypeC32
    Private Const COL_TypeC33 As Integer = 82             ' TypeC33
    Private Const COL_TypeC34 As Integer = 83             ' TypeC34
    Private Const COL_TypeC35 As Integer = 84             ' TypeC35
    Private Const COL_TypeC36 As Integer = 85             ' TypeC36
    Private Const COL_TypeC37 As Integer = 86             ' TypeC37
    Private Const COL_TypeC38 As Integer = 87             ' TypeC38
    Private Const COL_TypeC39 As Integer = 88             ' TypeC39
    Private Const COL_TypeC40 As Integer = 89             ' TypeC40
    Private Const COL_IsLocked As Integer = 90            ' IsLocked
    Private Const COL_UnitPrice01 As Integer = 91         ' UnitPrice01
    Private Const COL_UnitPrice02 As Integer = 92         ' UnitPrice02
    Private Const COL_UnitPrice03 As Integer = 93         ' UnitPrice03
    Private Const COL_UnitPrice04 As Integer = 94         ' UnitPrice04
    Private Const COL_UnitPrice05 As Integer = 95         ' UnitPrice05
    Private Const COL_CreateUserID As Integer = 96        ' Người tạo
    Private Const COL_CreateDate As Integer = 97          ' Ngày tạo
    Private Const COL_LastModifyUserID As Integer = 98    ' Người cập nhật cuối cùng
    Private Const COL_LastModifyDate As Integer = 99      ' Ngày cập nhật cuối cùng
    Private Const COL_PayrollVoucherID As Integer = 100   ' PayrollVoucherID
    Private Const COL_Apportion As Integer = 101          ' Apportion
    Private Const COL_OProductName As Integer = 102       ' OProductName
    Private Const COL_Total As Integer = 103
#End Region
...
#End Region
    ...
    Private Sub LoadCaptionTypeC()
        Dim sSQL As String = "--Do nguon ten cac cot loai dieu kien" & vbCrLf
        sSQL = "SELECT CODE, NameT AS ShortName, Disabled FROM 	D45T0030 ORDER BY CODE"
        Dim dt As DataTable = ReturnDataTable(sSQL)
        Dim j As Integer = 0 'dòng của table
        If dt.Rows.Count > 0 Then
            For i As Integer = COL_TypeC01 To COL_TypeC40
                tdbg.Splits(0).DisplayColumns(i).HeadingStyle.Font = FontUnicode(gbUnicode)
                tdbg.Columns(i).Caption = dt.Rows(j).Item("ShortName").ToString
                tdbg.Splits(0).DisplayColumns(i).Visible = L3Bool(IIf(dt.Rows(j).Item("Disabled").ToString = "1", 1, 0))
                j += 1
            Next
        End If
    End Sub
...
#End Region
    ...
    Private Function SQLInsertD45T2001s() As StringBuilder
        ...
        For i As Integer = 0 To tdbg.RowCount - 1
            If L3Bool(tdbg(i, COL_IsUpdated)) Then
                ...
                'id -125815   add 4o cot TypeC
                sSQL.Append(",TypeC01, TypeC02, TypeC03, TypeC04, TypeC05, TypeC06, TypeC07, TypeC08, TypeC09, TypeC10, ")
                sSQL.Append("TypeC11, TypeC12, TypeC13, TypeC14, TypeC15, TypeC16, TypeC17, TypeC18, TypeC19, TypeC20, ")
                sSQL.Append("TypeC21, TypeC22, TypeC23, TypeC24, TypeC25, TypeC26, TypeC27, TypeC28, TypeC29, TypeC30,")
                sSQL.Append("TypeC31, TypeC32, TypeC33, TypeC34, TypeC35, TypeC36, TypeC37, TypeC38, TypeC39, TypeC40")
                sSQL.Append(") Values(")
                ...
                sSQL.Append(SQLMoney(tdbg(i, COL_DetailApportionCoef)) & COMMA) 'DetailApportionCoef, decimal, NOT NULL
                'id -125815   add 4o cot TypeC
                For j As Integer = 1 To 39
                    'sSQL.Append(SQLString(tdbg(i, COL_TypeC01)) & COMMA)
                    sSQL.Append(SQLString(tdbg(i, IndexOfColumn(tdbg, "TypeC" + j.ToString("00")))) & COMMA)
                Next
                sSQL.Append(SQLString(tdbg(i, COL_TypeC40)))
    ...
    Private Sub MakeDropDownTypeC()
        Dim dt As DataTable = ReturnDataTable(SQLStoreD45P1151())
        For i As Integer = 1 To 40
            ...
            LoadDataSource(dd, ReturnTableFilter(dt, "FieldName='TypeC" & i.ToString("00") & "'"))
            tdbg.Columns(IndexOfColumn(tdbg, "TypeC" & i.ToString("00"))).DropDown = dd
        Next
    End Sub
    Private Function SQLStoreD45P1151() As String
        Dim sSQL As String = "--Đổ nguồn combo cot dong" & vbCrLf
        sSQL &= " EXEC D45P1151 "
        sSQL &= SQLString(gsDivisionID) & COMMA
        sSQL &= SQLString(gsUserID) & COMMA
        sSQL &= SQLString("D45F2006") & COMMA
