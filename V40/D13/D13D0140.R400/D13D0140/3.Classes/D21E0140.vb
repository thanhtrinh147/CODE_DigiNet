...
Public Class D21E0140
    ...
    Public Sub New(ByVal Server As String, ByVal Database As String, ByVal UserDatabaseID As String, ByVal Password As String, ByVal UserID As String, ByVal Language As String)
        ...
        '        'Update 4/5/2011: lấy biến CodeTable từ Registry
    ...
    ''' Mode
    ''' </summary>
    Public WriteOnly Property ModeD21F0030() As String
        Set(ByVal Value As String)
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "ModeD21F0030", Value)
        End Set
    End Property
