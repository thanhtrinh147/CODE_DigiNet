...
Public Class D25C1003

    Private WithEvents FormPreview As New D25F0002
...
ErrorHandles:
    ...
    Private Sub ExportToPDF()
        ...
        Try
            ...
            sExportFileName = PathExport & My.Computer.FileSystem.GetName(gsMainReportName1).Substring(0, 8) & "_" & _keyIDSendMail & ".pdf"
    ...
    Public Function SendMail(ByVal sSenderAddress As String, ByVal sReceivedAddress As String, ByVal sCCAddress As String, ByVal sBCCAddress As String, ByVal sSubject As String, ByVal sEmailContent As String, Optional ByVal sAttachmentFile As String = "", Optional ByVal sEmailUser As String = "", Optional ByVal sPassEmailUser As String = "") As Boolean
        ...
        Return sm.SendMail(sSenderAddress, sReceivedAddress, sCCAddress, sBCCAddress, sSubject, sEmailContent, sAttachmentFile, sEmailUser, sPassEmailUser)
