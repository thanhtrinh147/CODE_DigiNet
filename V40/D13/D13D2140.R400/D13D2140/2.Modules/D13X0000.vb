...
#End If
        ...
        Select Case PARA_FormID
            ...
            Case "D13F2026"
                ...
                With f
                    .ShowInTaskbar = True
                    .PayrollVoucherID = PARA_ID01
                    .SalaryVoucherID = PARA_ID02
                    .VoucherDate = PARA_ID03
                    .Description = PARA_ID04
                    .TransferMethodID = PARA_ID05
                    .DepartmentID = PARA_ID06
                    .TeamID = PARA_ID07
                    .EmpGroupID = PARA_ID12
                    .EmployeeID = PARA_ID08
                    .EmployeeName = PARA_ID09
                    .Find = PARA_ID10 'sFind
                    .BlockID = PARA_ID11
                    .ShowDialog()
                    .Dispose()
                End With
            Case "D13F2020"
                Dim f As New D13F2020
                With f
                    .ShowInTaskbar = True
                    .ShowDialog()
                    .Dispose()
    ...
    Private Sub LoadOthers()
        'UseAuditLog()
        LoadUserKey()
        giPerF5700 = ReturnPermission("D13F5700")
    ...
    Private Sub GetAllParameter()
        ...
        PARA_ID04 = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ID05", "")
        PARA_ID04 = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ID06", "")
        PARA_ID04 = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ID07", "")
        PARA_ID04 = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ID08", "")
        PARA_ID04 = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ID09", "")
        PARA_ID04 = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ID10", "")
        ...
        gsPayRollVoucherID = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "PayRollVoucherID", "")
