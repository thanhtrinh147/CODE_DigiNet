        ...
        Select Case PARA_FormID
            ...
            Case "D13F2012" 'Nghiệp vụ -->A. Hồ sơ lương cá nhân
                ...
                With f
                    .ShowInTaskbar = True
                    .Path = PARA_ID01
                    .PayrollVoucherID = PARA_ID02
                    .PayrollVoucherNo = PARA_ID03
                    .VoucherDate = Convert.ToDateTime(IIf(IsDate(PARA_ID04), PARA_ID04, Date.Now()))
                    .Description = PARA_ID05
                    .ShowDialog()
                    .Dispose()
                End With
