...
Module D13X0004
    ...
    Public Sub LoadOptions()
        ...
        With D13Options
            ...
            Dim Dxx As String = "D" & ModuleID 'PARA_ModuleID: lấy giá trị tại hàm GetAllParameter() : PARA_ModuleID = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ModuleID", xx)
    ...
    Private Function GetFormatDateType() As String
...
#End If
    ...
    Public Function CheckKeyPressSpecialCharactor(ByVal str As String) As Boolean
        ...
        'If str.IndexOf(Chr(95)) >= 0 Then Return True '_
        Return False
    End Function
