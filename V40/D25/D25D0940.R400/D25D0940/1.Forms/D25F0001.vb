...
#End Region
    ...
    Private Sub btnClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClose.Click
        bFormClosed = True
        If _FormState = EnumFormState.FormAdd Then Exit Sub 'End
        Me.Close()
    End Sub
    ...
    Private Sub D25F0001_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        If _FormState = EnumFormState.FormAdd And Not bFormClosed Then Exit Sub ' End
        ' Me.Close()
    End Sub
    ...
    Private Sub Loadlanguage()
        ...
        TabAuto.Text = "2." & rL3("Thiet_lap_ma_tu_dong") 'Thiết lập mã tự động
        TabOther.Text = "3." & rL3("Khac") 'Khác
        '================================================================ 
        ...
        optRecruimentActualQTYMode0.Text = rL3("NV_da_lap_quyet_dinh_tuyen_dung_co_trang_thai_nhan_viec") 'NV đã lập quyết định tuyển dụng có trạng thái nhận việc
    ...
    Private Sub LoadEdit()
        ...
        If gbIsDesktop Then 'ID 88532 29/06/2016
    ...
    Private Function AllowSave() As Boolean
        If gbIsDesktop = False AndAlso tdbcDivisionID.Text = "" Then 'ID 88532 29/06/2016
    ...
    Private Sub UpadateSystems()
        With D25Systems
            If gbIsDesktop = False Then .DefaultDivisionID = ReturnValueC1Combo(tdbcDivisionID).ToString 'ID 88532 29/06/2016
    ...
    Private Function SQLInsertD25T0000() As StringBuilder
        ...
        sSQL.Append("AutoInterviewFileID,RecruimentActualQTYMode")
        sSQL.Append(") Values(")
    ...
    Private Function SQLUpdateD25T0000() As StringBuilder
        ...
        If gbIsDesktop = False Then 'ID 88532 29/06/2016
