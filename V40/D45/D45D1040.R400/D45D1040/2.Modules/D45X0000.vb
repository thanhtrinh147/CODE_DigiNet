...
#End If
    ...
    Private Sub GetAllParameter()
        ...
        PARA_TranMonth = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "TranMonth", "??")
        PARA_TranYear = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "TranYear", "????")
        ...
        PARA_ProductVoucherID = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ProductVoucherID", "")
        PARA_SalaryVoucherID = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "SalaryVoucherID", "")
        PARA_PayrollVoucherID = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "PayrollVoucherID", "")
        PARA_TransTypeID = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "TransTypeID", "")
        PARA_Mode = CInt(D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "Mode", "0"))

        PARA_FormState = CType(D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "FormState", "1"), EnumFormState)
        'Update 02/11/2010: lấy biến CodeTable từ Registry
    ...
    Private Sub SaveParameter()
        ...
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "TranMonth", "11")
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "TranYear", "2011")
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Language", "0")
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Ctrl01", "D45F1020") 'PARA_FormID
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Ctrl03", "D45F1020") 'PARA_FormIDPermission
    End Sub
