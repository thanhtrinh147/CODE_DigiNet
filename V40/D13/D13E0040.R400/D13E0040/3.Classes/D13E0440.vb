Public Enum enumD13E0440Form
    D13F3010 'Truy vấn -->A. Chuyển bút toán
    D13F3020 'Truy vấn -->B. Quỹ trợ cấp thôi việc
    D13F3030 'Truy vấn -->E. Lịch sử lương
    D13F3050 'Truy vấn -->F. Đối chiếu dữ liệu tính lương
End Enum

Public Class D13E0440
    Private Const EXEMODULE As String = "D13"
    Private Const EXECHILD As String = "D13E0440"
    Private sLanguage As String

    ''' <summary>
    ''' Khởi tạo exe con D13E0440
    ''' </summary>
    ...
    ''' </summary>
    Public WriteOnly Property FormActive() As enumD13E0440Form
        Set(ByVal Value As enumD13E0440Form)
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Ctrl01", [Enum].GetName(GetType(enumD13E0440Form), Value))
        End Set
    End Property
