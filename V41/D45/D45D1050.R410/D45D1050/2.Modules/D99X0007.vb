...
'# Ngày cập nhật cuối cùng: 23/05/2013
...
#Region "FooterText của lưới"
    Public Sub FooterSumNew(ByVal tdbg As C1.Win.C1TrueDBGrid.C1TrueDBGrid, ByVal ParamArray oColumns() As Object)
    ...
    Public Sub FooterSumFilter(ByVal tdbg As C1.Win.C1TrueDBGrid.C1TrueDBGrid, ByVal sFilter As String, ByVal ParamArray oColumns() As Object)
        ...
        For j As Integer = 0 To oColumns.Length - 1
            Dim sCol As String = ""
            If Not CastObjToStrCol(tdbg, oColumns(j), sCol) Then Continue For
            If dt.Columns.Contains(sCol) = False Then Continue For
            tdbg.Columns(sCol).FooterText = CalSUMCol(dt, sCol, tdbg.Columns(sCol).NumberFormat, strFilter)
        Next
    End Sub
...
#Region "Set FormatTextEvent và Cal footer"
    ...
    Public Sub AddColFormatText(ByRef dtFormat As DataTable, ByVal tdbg As C1.Win.C1TrueDBGrid.C1TrueDBGrid, ByVal NumberFormat As String, ByVal oColumn As Object, Optional ByVal IsSum As Boolean = True)
        Dim sCol As String = ""
        If Not CastObjToStrCol(tdbg, oColumn, sCol) Then Exit Sub
        ...
        tdbg.Columns(sCol).Tag = NumberFormat
    ...
    Public Sub AddColFormatText(ByRef dtFormat As DataTable, ByVal tdbg As C1.Win.C1TrueDBGrid.C1TrueDBGrid, ByVal NumberFormat As String, ByVal ParamArray oColumn() As Object)
        For i As Integer = 0 To oColumn.Length - 1
            AddColFormatText(dtFormat, tdbg, NumberFormat, oColumn(i))
        Next
    End Sub
