...
Public Class D13E0240
    Private Const EXEMODULE As String = "D13"
    Private Const EXECHILD As String = "D13E0240"
    ...
    Public WriteOnly Property FormActive() As enumD13E0240Form
        Set(ByVal Value As enumD13E0240Form)
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Ctrl01", [Enum].GetName(GetType(enumD13E0240Form), Value))
        End Set
    End Property
