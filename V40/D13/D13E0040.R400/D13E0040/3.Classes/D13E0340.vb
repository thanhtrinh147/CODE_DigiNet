Public Enum enumD13E0340Form
    D13F4010 'Báo cáo ---> B. Điều chỉnh thu nhập
    D13F4020 'Báo cáo ---> C. Bảng lương công ty
    D13F4060 'Báo cáo ---> E. Khai thuế TNCN
    D13F4070 'Báo cáo ---> F. Quyết toán thuế TNCN
    D13F4030 'Báo cáo ---> G. Thiết lập bảng lương
    D13F4040 'Báo cáo phiếu lương (gọi từ Bảng lương CBCNV - D13F2042)
End Enum

Public Class D13E0340
    Private Const EXEMODULE As String = "D13"
    Private Const EXECHILD As String = "D13E0340"
    Private sLanguage As String

    ''' <summary>
    ''' Khởi tạo exe con D13E0340
    ''' </summary>
    ...
    ''' </summary>
    Public WriteOnly Property FormActive() As enumD13E0340Form
        Set(ByVal Value As enumD13E0340Form)
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Ctrl01", [Enum].GetName(GetType(enumD13E0340Form), Value))
        End Set
    End Property
    ...
    Public WriteOnly Property ID11() As String
        Set(ByVal Value As String)
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "ID11", Value)
        End Set
    End Property

    Public WriteOnly Property ID12() As String
        Set(ByVal Value As String)
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "ID12", Value)
        End Set
    End Property

    Public WriteOnly Property ID13() As String
        Set(ByVal Value As String)
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "ID13", Value)
        End Set
    End Property
