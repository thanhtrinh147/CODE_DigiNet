...
#End If
    ...
    Private Sub GetAllParameter()
        ...
        '-----------------------------------------------------------------------
        'IncidentID	50891  Dùng để truyền vào store D09T2016 biến module ID : 09,25
        'Khái báo biến PARA_ModuleID trong mỗi module: Public PARA_ModuleID As String = "25"
        PARA_ModuleID = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ModuleID", "")
