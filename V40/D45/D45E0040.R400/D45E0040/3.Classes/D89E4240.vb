...
Public Class D89E4240
    Private Const EXEMODULE As String = "D89"
    Private Const EXECHILD As String = "D89E4240"
    ...
    ''' </summary>
    Public WriteOnly Property FormActive() As D89E4240Form
        Set(ByVal Value As D89E4240Form)
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Ctrl01", [Enum].GetName(GetType(D89E4240Form), Value))
        End Set
    End Property
