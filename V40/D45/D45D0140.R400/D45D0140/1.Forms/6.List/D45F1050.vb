Imports System
Public Class D45F1050

#Region "Const of tdbg"
    Private Const COL_PieceworkGroupID As Integer = 0   ' Mã
    Private Const COL_PieceworkGroupName As Integer = 1 ' Tên
    Private Const COL_Note As Integer = 2               ' Ghi chú
    Private Const COL_GroupManagerName As Integer = 3   ' Trưởng nhóm
    Private Const COL_Disabled As Integer = 4           ' KSD
...
#End Region
    ...
    Public Property CallModuleID() As String 
        Get
            Return _callModuleID
        End Get
    ...
    Private _formIDPermission As String = "D45F1050"
    Public Property FormIDPermission() As String 
        Get
            Return _formIDPermission
        End Get
        Set(ByVal Value As String )
...
#Region "Form"
    ...
    Private Sub D45F1050_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Loadlanguage()
        '================================================================ 
        Me.Text = rl3("Danh_sach_nhom_nhan_vien_cham_cong_Danh_gia_-_D45F1050") & UnicodeCaption(gbUnicode) 'Danh sÀch nhâm nh¡n vi£n chÊm c¤ng/ ˜Ành giÀ - D45F1050
        If _callModuleID = "D39" Then Me.Text = Me.Text.Replace("D45F1050", "D39F1070")
        '================================================================ 
        tdbg.Columns("PieceworkGroupID").Caption = rl3("Ma") 'Mã
        tdbg.Columns("PieceworkGroupName").Caption = rl3("Ten") 'Tên
        tdbg.Columns("Note").Caption = rl3("Ghi_chu") 'Ghi chú
        tdbg.Columns("GroupManagerName").Caption = rl3("Truong_nhom") 'Trưởng nhóm
    ...
    Private Sub LoadTDBGrid(Optional ByVal FlagAdd As Boolean = False, Optional ByVal sKey As String = "")
        Dim sSQL As String
        sSQL = "SELECT 	PieceworkGroupID, PieceworkGroupName" & UnicodeJoin(gbUnicode) & " as PieceworkGroupName, Note" & UnicodeJoin(gbUnicode) & " as Note, Disabled, CreateUserID, CreateDate," & vbCrLf
        sSQL &= "LastModifyUserID, LastModifyDate, GroupProductID, GroupManagerName" & UnicodeJoin(gbUnicode) & " as GroupManagerName" & vbCrLf
        sSQL &= "From D45T1050 D50  WITH(NOLOCK) Order by PieceworkGroupID"
        ...
        If sKey <> "" Then
            ...
            Dim dr() As DataRow = dt1.Select("PieceworkGroupID = " & SQLString(sKey), dt1.DefaultView.Sort)
...
#Region "Menu"
    ...
    Private Sub tsbAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles tsbAdd.Click, tsmAdd.Click, mnsAdd.Click
        Dim f As New D45F1051
        With f
            .PieceworkGroupID = ""
            .CallModuleID = _callModuleID
            .FormState = EnumFormState.FormAdd
            .ShowDialog()
            Dim sKey As String = .PieceworkGroupID
            .Dispose()
            If .bSaved Then
    ...
    Private Sub tsbView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles tsbView.Click, tsmView.Click, mnsView.Click
        Dim f As New D45F1051
        f.PieceworkGroupID = tdbg.Columns(COL_PieceworkGroupID).Text
        f.CallModuleID = _callModuleID
    ...
    Private Sub tsbEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles tsbEdit.Click, tsmEdit.Click, mnsEdit.Click
        ...
        f.ShowDialog()
        Dim sKey As String = f.PieceworkGroupID
        f.Dispose()
        If f.bSaved Then
    ...
    Private Sub tsbDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles tsbDelete.Click, tsmDelete.Click, mnsDelete.Click
        ...
        Dim sSQL As String = ""
        sSQL = "Delete D45T1050 Where PieceworkGroupID=" & SQLString(tdbg.Columns(COL_PieceworkGroupID).Text) & vbCrLf
        sSQL &= "Delete D45T1051 Where PieceworkGroupID=" & SQLString(tdbg.Columns(COL_PieceworkGroupID).Text) & vbCrLf
    ...
    Private Function SQLStoreD45P5555() As String
        ...
        sSQL &= SQLString(IIf(_callModuleID = "D39", "D39F1070", "D45F1050").ToString) & COMMA 'FormID, varchar[20], NOT NULL
        sSQL &= SQLString(tdbg.Columns(COL_PieceworkGroupID).Text) & COMMA 'Key01ID, varchar[20], NOT NULL
