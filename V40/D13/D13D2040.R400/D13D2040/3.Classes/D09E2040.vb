...
Public Class D09E2040
    Private Const EXEMODULE As String = "D09"
    Private Const EXECHILD As String = "D09E2040"
    ...
    Public WriteOnly Property FormActive() As D09E2040Form
        Set(ByVal Value As D09E2040Form)
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Ctrl01", [Enum].GetName(GetType(D09E2040Form), Value))
        End Set
    End Property
    ...
    Public WriteOnly Property ShowEmpStopWork() As String
        Set(ByVal Value As String)
            If Value Is Nothing Then Value = ""
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "ShowEmpStopWork", Value)
        End Set
    End Property
    ...
    Public WriteOnly Property Voucher01ID() As String
        Set(ByVal Value As String)
            If Value Is Nothing Then Value = ""
            D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Voucher01ID", Value)
        End Set
    End Property
    ...
    ''' </summary>
    ''' <value></value>
    ''' <remarks>Truyền FormID vào store để xử lý</remarks>
    ...
    Public ReadOnly Property Out_SavedOK() As String
        Get
            Return D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ButtonChoose", "False")
        End Get
    End Property
