...
Module D13X0001
    ...
    '    ''' <summary>
    '    ''' Module đang coding D13E2040
    '    ''' </summary>
    '    Public Const MODULED13 As String = "D13E2040"
    '    ''' <summary>
    '    ''' Chuỗi D13
    '    ''' </summary>
    ...
    Public Enum Button
        ...
        Income = 1                    ' Thu nhập
        NextBaseSalary = 2            '  Lương tiếp theo
        AnalyseCode = 3               ' Mã phân tích nhân sự
        SalaryLevelOfficialTitle = 4  ' Ngạch bậc lương
        Debit = 5                     ' Tài khoản nợ
        Credit = 6                    ' Tài khoản có
        Ana = 7                       ' Khoản mục
        AnalyseSalary = 8             ' Mã phân tích tiền lương
        SalaryPaymentMethod = 9       ' Phương pháp trả lương
        InfoCalculated = 10           ' Thông tin quyết toán
        InfoTaxIncome = 11            ' Thông tin khai thuế  
        InfoInsurance = 13            ' Thông tin bảo hiểm
        InfoOther = 13                ' Thông tin khác
        FamilyDeduction = 14          ' Giảm trừ gia cảnh
        Bank = 15                     ' Ngân hàng 
    ...
    Public Structure SALCE
        ...
        Public CE11 As Boolean 'Update 10/02/2010: inicident 45882 thêm tiếp 10 HSL
    ...
    ''' Định nghĩa các giá trị boolean của các mã phân tích dùng để cột Thông tin khác tương ứng hiển thị 
    ''' khi Thông tin khác đó hiện tại có sử dụng hay ẩn đi khi Thông tin khác đó hiện tại không sử dụng
    ''' </summary>
    Public Structure InfoOther
        Public Ref01 As Boolean
        Public Ref02 As Boolean
        Public Ref03 As Boolean
        Public Ref04 As Boolean
        Public Ref05 As Boolean
        Public NumRef01 As Boolean
        Public NumRef02 As Boolean
        Public NumRef03 As Boolean
        Public NumRef04 As Boolean
        Public NumRef05 As Boolean
        Public NumRef06 As Boolean
        Public NumRef07 As Boolean
        Public NumRef08 As Boolean
        Public NumRef09 As Boolean
        Public NumRef10 As Boolean
    End Structure
