Public Class D13F7777
    ...
    Private Sub FillCaption()
        If geLanguage = EnumLanguage.Vietnamese Then
            ...
            F4 = "Xóa dữ liệu trên cột từ vị trí con trỏ đang đứng"
            F6 = "Kế thừa dữ liệu"
            F9 = "Copy tất cả các cột từ vị trí con trỏ đang đứng"
        ...
        Else
            ...
            F4 = "Delete data on column from position current currsor"
            F6 = " Inherit data"
    ...
    Public Sub CallShowForm(ByVal sForm As String)
        ...
        If sForm = "D13F2022" Then
            CreateLabelS("F6", F6, Color.Black)
        End If
        CreateLabelS("F9", F9, Color.Black)
